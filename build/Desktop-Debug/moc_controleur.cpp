...
QT_MOC_LITERAL(5, 35, 14), // "sendAffichage2"
QT_MOC_LITERAL(6, 50, 6), // "envoi2"
QT_MOC_LITERAL(7, 57, 8), // "newDatas"
QT_MOC_LITERAL(8, 66, 2), // "on"
QT_MOC_LITERAL(9, 69, 3) // "off"

    },
    "Controleur\0deplacer\0\0vitesse\0angle\0"
    "sendAffichage2\0envoi2\0newDatas\0on\0off"
};
...
void Controleur::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendAffichage2((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->newDatas(); break;
        case 3: _t->on(); break;
        case 4: _t->off(); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Controleur::sendAffichage2)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Controleur::sendAffichage2(QString _t1)
{
